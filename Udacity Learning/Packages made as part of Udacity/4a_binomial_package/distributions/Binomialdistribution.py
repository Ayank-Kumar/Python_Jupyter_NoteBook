...
class Binomial(Distribution):
    ...
    def plot_bar(self):
        ...
        plt.bar([0,1],[self.n-self.n*self.p,self.n*self.p])
        plt.title(label='Bar Graph')
    ...
    def pdf(self, k):
        ...
        second = math.pow(self.p,k)*math.pow(1-self.p,self.n-k)
        return first*second        
    ...
    def plot_bar_pdf(self):
        ...
        y = [self.pdf(n) for n in x]

        plt.bar(x,y)
        plt.title('Bar-Graph')
        plt.xlabel('x-axis')
        plt.ylabel('y-axis')
        # jaha pai show krne ko bola waha show krne ka
        plt.show()
        return x,y
    ...
    def __add__(self, other):
        ...
        sum_binomial = Binomial(prob=self.p,size=self.n+other.n)
        return sum_binomial
